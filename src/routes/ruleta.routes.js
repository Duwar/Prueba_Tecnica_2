...
import {createRoulette, openRoulette, closeRoulette, listRoulettes,resultadoRoulettes} from "../controllers/ruleta.controller.js";
...
ruletasRouter.get('/resultado/:rouletteId', resultadoRoulettes);
